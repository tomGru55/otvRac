...
@Repository
public interface OscarsDao extends JpaRepository<oscars, Long> {
    String filterDataQuery = "SELECT o FROM oscars o "+
        "where ( "+
        "("+
        ":selectOption = 'wildcard' and ("+
        "o.nazivCeremonije like %:keyword% or o.datumCeremonije like %:keyword% or CAST(o.id AS string) like %:keyword% or o.lokacijaCeremonije like %:keyword% or o.kategorijaNagrade like %:keyword% "+
        "or o.film  like %:keyword% or o.dobitnikIme like %:keyword%  or o.dobitnikPrezime like %:keyword%  or o.dobitnikDatumrod like %:keyword%  "+
        ...
        "(:selectOption = 'nazivCeremonije' and o.nazivCeremonije like %:keyword%)"+
            "or "+
            "(:selectOption = 'id' and CAST(o.id AS string) like %:keyword%)"+
        "or"+
        "(:selectOption = 'datumCeremonije' and o.datumCeremonije like %:keyword%)"+
        "or"+
        ...
        "or"+
        "(:selectOption = 'dobitnikDatumrod' and o.dobitnikDatumrod like %:keyword%)"+
        "or"+
   ...
   @Query(filterDataQuery)
    ...
    List<oscars> findByDobitnikPrezime(String dobitnikPrezime);
    List<oscars> findByDobitnikIme(String dobitnikIme);
}
